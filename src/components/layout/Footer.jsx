 ...
 * Incluye enlaces, información de contacto y redes sociales
 */
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/" className="text-gray-300 hover:text-india-orange transition-colors text-sm">
                  → Inicio
                </a>
              </li>
              <li>
                <a href="/sobre-nosotros" className="text-gray-300 hover:text-india-orange transition-colors text-sm">
                  → Sobre Nosotros
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/eventos" className="text-gray-300 hover:text-india-orange transition-colors text-sm">
                  → Próximos Eventos
                </a>
              </li>
              <li>
                <a href="/contacto" className="text-gray-300 hover:text-india-orange transition-colors text-sm">
                  → Contacto
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/catering" className="text-gray-300 hover:text-india-orange transition-colors text-sm">
                  → Catering para Eventos
                </a>
              </li>
              <li>
                <a href="/foodtruck" className="text-gray-300 hover:text-india-orange transition-colors text-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a href="/politica-privacidad" className="hover:text-india-orange transition-colors">
                Política de Privacidad
              </a>
              <span>•</span>
              <a href="/terminos-servicio" className="hover:text-india-orange transition-colors">
                Términos de Servicio
              </a>
              <span>•</span>
              <a href="/cookies" className="hover:text-india-orange transition-colors">
                Cookies
              </a>
            </div>
